...
use App\Models\PiazziniRestaurantBooking;
use Illuminate\Support\Facades\Validator;

class PiazziniRestaurantBookingController extends Controller
{
    public function index()
    {
        $bookings = PiazziniRestaurantBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $bookings = new PiazziniRestaurantBooking();
    ...
    {
        $bookings = PiazziniRestaurantBooking::find($id);
