...
use App\Models\SachiHeliopolisrestaurantBooking;
use Illuminate\Support\Facades\Validator;
class SachiHeliopolisController extends Controller
{
    public function index()
    {
        $bookings = SachiHeliopolisrestaurantBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $bookings = new SachiHeliopolisrestaurantBooking();
    ...
    {
        $bookings = SachiHeliopolisrestaurantBooking::find($id);
