...
use App\Models\LeDeckRestaurantBooking;
use Illuminate\Support\Facades\Validator;
use Carbon\Carbon;
class LeDeckRestaurantBookingController extends Controller
{
    public function index()
    {
        $bookings = LeDeckRestaurantBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $booking = new LeDeckRestaurantBooking();
    ...
    {
        $booking = LeDeckRestaurantBooking::find($id);
