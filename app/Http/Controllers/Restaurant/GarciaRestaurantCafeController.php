...
use App\Models\GarciaRestaurantCafeBooking;
use Illuminate\Support\Facades\Validator;
class GarciaRestaurantCafeController extends Controller
{
    public function index()
    {
        $bookings = GarciaRestaurantCafeBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $booking = new GarciaRestaurantCafeBooking();
    ...
    {
        $booking = GarciaRestaurantCafeBooking::find($id);
