...
use App\Models\MezcalRestaurantBooking;
use Illuminate\Support\Facades\Validator;
class MezcalRestaurantBookingController extends Controller
{
    public function index()
    {
        $bookings = MezcalRestaurantBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $booking = new MezcalRestaurantBooking();
    ...
    {
        $booking = MezcalRestaurantBooking::find($id);
