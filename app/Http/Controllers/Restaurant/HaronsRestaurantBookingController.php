...
use App\models\HaronsRestaurantBooking;
use Illuminate\Support\Facades\Validator;
class HaronsRestaurantBookingController extends Controller
{
    public function index()
    {
        $bookings = HaronsRestaurantBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $booking = new HaronsRestaurantBooking();
    ...
    {
        $booking = HaronsRestaurantBooking::find($id);
