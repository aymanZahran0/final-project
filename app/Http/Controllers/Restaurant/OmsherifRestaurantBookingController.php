...
use App\Models\OmsherifRestaurantBooking;
use Illuminate\Support\Facades\Validator;
class OmsherifRestaurantBookingController extends Controller
{

    public function index()
    {
        $bookings = OmsherifRestaurantBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $bookings = new OmsherifRestaurantBooking();
    ...
    {
        $bookings = OmsherifRestaurantBooking::find($id);
