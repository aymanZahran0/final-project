...
use App\Models\ShalaolaoRestaurantBooking;
use Illuminate\Support\Facades\Validator;
class ShalaolaoRestaurantBookingController extends Controller
{
    public function index()
    {
        $bookings = ShalaolaoRestaurantBooking::all();
    ...
    public function store(Request $request)
    {
        ...
        $bookings = new ShalaolaoRestaurantBooking();
    ...
    {
        $bookings = ShalaolaoRestaurantBooking::find($id);
